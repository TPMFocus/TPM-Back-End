...
def generate_text(data):
    try:
        ...
        try:
            ...
            chat_response = remove_json_from_string(assistant_message_content).replace("```json", "").replace("```", "")
